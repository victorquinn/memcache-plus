...
Connection.prototype.read = function(data) {
    ...
    if (data.toString() === 'ERROR') {
    ...
    } else if (data.toString().substr(0, 5) === 'VALUE') {
        ...
        this.data = null;
    } else if (data.toString() === 'STORED') {
        this.queue.shift();
        deferred.resolve(data);
        this.data = null;
    } else if (data.toString() === 'DELETED' || data.toString() === 'EXISTS') {
        this.queue.shift();
        deferred.resolve(data);
        this.data = null;
        ...
        this.queue.shift();
        deferred.reject(data.toString().substr(13));
        this.data = null;
    } else {
